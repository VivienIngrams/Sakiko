...
const Book: FC = memo(() => {
  ...
  return (
    <>
      <Header />
      <Section className="bg-black" sectionId={SectionId.Book}>
        <div className={classNames('grid grid-cols-1 gap-y-4', {'md:grid-cols-4': !!profileImageSrc})}>
          <div
            ...
            <ul className="grid grid-cols-3 col-span-5 gap-5 sm:grid-cols-3 ">
            ...
            <div className="flex flex-wrap justify-center ">
              {!!profileImageSrc && (
                <div className="col-span-1 m-10 flex justify-center md:justify-start">
                  <div className="md:h-60 relative h-40 w-40 overflow-hidden rounded-xl md:w-40">
