      ...
      <div className={classNames('grid grid-cols-1 gap-y-4', {'md:grid-cols-4': !!profileImageSrc})}>
        <div
          ...
          <div className="flex flex-col items-center gap-y-2">
            ...
            <p className="prose prose-sm p-5 text-center text-gray-300 sm:prose-base">{description}</p>
            {!!profileImageSrc && (
              <div className="col-span-1 flex justify-center md:justify-start">
                <div className="relative h-40 w-40 overflow-hidden rounded-xl md:h-32 md:w-32">
            ...
            <p className="prose prose-sm p-5 text-center text-gray-300 sm:prose-base">{description2}</p>
