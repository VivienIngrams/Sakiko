...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.About, SectionId.Portfolio,  SectionId.Testimonials, SectionId.Resume ],
    [],
  );
...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    const activeClass = classNames(baseClass, 'text-red-900');
    ...
    return (
      <>
        <button
          ...
          className="fixed top-2 right-2 z-40 rounded-md bg-orange-900 p-2 ring-offset-gray-800/60 hover:bg-orange-400 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
